...
def execute_pipeline(
    ...
    try:
        ...
        # Save CV metrics to a separate file
        cv_metrics_data = {
            "cv_metrics": bb_results["cv_metrics"],
            "metadata": {
                "n_splits": n_splits,
        ...
        cv_metrics_path = save_json_results(cv_metrics_data, output_dir, "cv_metrics")
        ...
        # Remove the cv_metrics from the main pipeline results
        pipeline_results = {
            "metadata": {
            ...
            "black_box_results": {
                "test_metrics": bb_results["test_metrics"],
                "feature_importance_path": bb_results["feature_importance_path"],
            },
